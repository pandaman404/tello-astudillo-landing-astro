...
export function Hero({ heroImage, siteConfig, stats }: HeroProps) {
  ...
  return (
    ...
    >
      ...
      <div className="mx-auto grid hero-min-h max-w-7xl grid-cols-12 items-center gap-x-6 gap-y-10 px-6 py-20 sm:min-h-[88vh] sm:py-24 md:gap-x-8 md:gap-y-12 md:px-8 md:py-28 lg:min-h-[92vh] lg:gap-x-6 lg:py-24">
        {/* Left: headline + CTAs */}
        <div className="col-span-12 md:col-span-7 md:pr-4 lg:col-span-8 lg:pr-0">
          <div className="animate-fade-in-up mb-6 flex items-center gap-3 text-xs font-semibold uppercase tracking-[0.3em] text-accent sm:mb-8 md:mb-7">
            <span className="h-px w-10 bg-accent" />
            Desde 1988 · Industria nacional chilena
          </div>

          <h1 id="hero-heading" className="animate-fade-in-up delay-100 max-w-[11ch] font-heading text-[clamp(2.75rem,8vw,5.5rem)] leading-[0.9] tracking-tight text-foreground sm:max-w-[10.5ch] sm:leading-[0.88] md:max-w-none md:text-[clamp(3.45rem,6vw,4.85rem)] lg:text-[clamp(2.75rem,8vw,5.5rem)]">
            SOCIOS ESTRATÉGICOS
            <br />
          ...
          <p className="animate-fade-in-up delay-200 mt-6 max-w-xl text-sm leading-relaxed text-foreground sm:mt-8 md:mt-7 md:max-w-lg md:text-[15px] lg:text-lg">
          ...
          <div className="animate-fade-in-up delay-300 mt-8 flex flex-col gap-3 sm:mt-10 sm:flex-row sm:flex-wrap sm:items-center sm:gap-4 md:mt-9 md:gap-3 lg:gap-4">
            <a
              href="#contacto"
              className="btn-sweep group inline-flex items-center justify-center gap-3 clip-corner bg-primary px-8 py-4 text-sm font-semibold uppercase tracking-wider text-primary-foreground shadow-blue transition-all hover:brightness-125 sm:w-auto md:min-w-[220px]"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="hover-lift inline-flex items-center justify-center gap-3 border border-accent/50 bg-accent/10 px-8 py-4 text-sm font-semibold uppercase tracking-wider text-accent backdrop-blur-sm transition-colors hover:bg-accent hover:text-accent-foreground sm:w-auto md:min-w-[180px]"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="hover-lift inline-flex items-center justify-center gap-3 border border-primary/50 bg-primary/10 px-8 py-4 text-sm font-semibold uppercase tracking-wider text-accent backdrop-blur-sm transition-colors hover:bg-primary/20 hover:text-foreground sm:w-auto md:min-w-[180px]"
            >
        ...
        {/* Right: stats grid */}
        <div className="animate-fade-in-up delay-400 col-span-12 md:col-span-5 md:self-end lg:col-span-4 lg:self-auto">
